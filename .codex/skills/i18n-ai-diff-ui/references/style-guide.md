...
- Preserve the English product terms `Multi-master`, `Single-master`, `Master routes`, `File tasks`, `Cache`, and `Snapshot`. In Simplified Chinese, render the mode terms as `多母版模式` and `单母版模式`.
